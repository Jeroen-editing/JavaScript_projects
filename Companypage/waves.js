/*import anime from '../../../Users/jeroendevos/node_modules/animejs/lib/anime.min.js';*/
...
if (videoHeight >= 640) {
    main.style.top = `720px`;
} else {
    main.style.top = `${videoHeight + (videoHeight / 5)}px`;
}


anime ({
    targets: '.wave_top > path',
    easing: 'linear',
    duration: 7500,
    loop: true,
    d: [
